          ...
          {education.map((item) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center justify-center w-11 h-11 rounded-full border border-[#13D6E9]/30 text-[#13D6E9] transition-all duration-300 group-hover:bg-[rgb(19,214,233)] group-hover:text-black  group-hover:shadow-[0_0_16px_hsl(var(--[#13D6E9])/0.4)]">
              ...
              {/* Period */}
              <span className="text-xs font-semibold tracking-wider text-[#13D6E9]/80 mb-2">
                {item.period}
              </span>
              ...
              <div className="mt-6 pt-4 border-t border-border/40 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#13D6E9] inline-block shadow-[0_0_8px_hsl(var(--[#13D6E9])/0.5)]" />
