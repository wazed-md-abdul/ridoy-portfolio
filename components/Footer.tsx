...
const Footer = () => {
  return (
    <footer className="w-full pt-20 pb-10 relative z-10" id="contact">
      {/* background grid */}
      <div className="w-full absolute left-0 -bottom-72 min-h-96 pointer-events-none overflow-hidden -z-10">
        <img
          src="/footer-grid.svg"
          alt="grid"
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center relative z-10">
        ...
        <div className="flex items-center md:gap-3 gap-6 relative z-10">
          {socialMedia.map((info) => (
            ...
            >
              <img src={info.img} alt="icons" width={20} height={20} className="object-contain" />
            </div>
          ))}
        </div>
      </div>
