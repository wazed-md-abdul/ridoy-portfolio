  ...
  return (
    <section className="relative w-full pt-28 pb-16 sm:pt-36 sm:pb-24 flex flex-col items-center justify-center text-center font-mono">
      ...
      >
        ...
        {/* Write a Letter Linear Modal Trigger & Container */}
        <div className="mt-10 sm:mt-12 flex items-center justify-center">
          ...
          >
            <DialogTrigger className="group relative px-7 py-3.5 rounded-full font-bold text-xs sm:text-sm tracking-widest uppercase overflow-hidden border border-[#13D6E9]/60 bg-[#04071D]/90 text-white shadow-[0_0_24px_rgba(19,214,233,0.3)] hover:shadow-[0_0_35px_rgba(19,214,233,0.6)] hover:border-[#13D6E9] transition-all duration-300">
            ...
            <DialogContainer>
              <DialogContent className="w-full max-w-lg p-6 sm:p-8 border border-[#13D6E9]/40 bg-[#04071D]/98 text-left shadow-[0_0_50px_rgba(19,214,233,0.25)] relative">
                <DialogClose />
                <DialogTitle className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                  <span>Send a Note to Hriday</span>
                  <span>✉️</span>
                </DialogTitle>
                <DialogSubtitle className="text-xs text-[#13D6E9] mt-0.5 mb-6 border-b border-white/10 pb-4">
                  I read every personal letter.
                </DialogSubtitle>
